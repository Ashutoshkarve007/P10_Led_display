...
void messageHandler(char* topic, byte * payload, unsigned int length)
{
  ...
  commandss = doc["commandss"];
  Serial.println(commandss);
...
void switchcommands()
{
  ...
  switch (cmd)
  {
    case 1:
      ...
      dmd.drawString(x, y, Data, strlen(Data), GRAPHICS_NORMAL );
      if (ani == 0) {
        dmd.clearScreen( true );
        f = "SystemFont5x7";
        dmd.selectFont(SystemFont5x7);
...
void commands()
{
  ...
  else if (command == "f2" or commandss == "f2") {
    dmd.clearScreen( true );
    f = "Arial_black_16";
    dmd.selectFont(Arial_Black_16);
    dmd.drawString(1, 5, Data, strlen(Data), GRAPHICS_NORMAL );
  ...
  else if (command == "f3" or commandss == "f3") {
    dmd.clearScreen( true );
    f = "Arial_38b";
    dmd.selectFont(Arial_38b);
    dmd.drawString(1, 5, Data, strlen(Data), GRAPHICS_NORMAL );
  ...
  else if (command == "f4" or commandss == "f4") {
    dmd.clearScreen( true );
    f = "Arial_Black_16_ISO_8859_1";
    dmd.selectFont(Arial_Black_16_ISO_8859_1);
    dmd.drawString(1, 5, Data, strlen(Data), GRAPHICS_NORMAL );
  ...
  else if (command == "f5" or commandss == "f5") {
    dmd.clearScreen( true );
    f = "Arial_Black21";
    dmd.selectFont(Arial_Black21);
    dmd.drawString(1, 5, Data, strlen(Data), GRAPHICS_NORMAL );
